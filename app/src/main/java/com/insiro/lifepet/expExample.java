...
import com.insiro.lifepet.databinding.ActivityExpExampleBinding;

public class expExample extends AppCompatActivity {

    private AppBarConfiguration appBarConfiguration;
    private ActivityExpExampleBinding binding;
    public float exp=0;
